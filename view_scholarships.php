...
<body>
    ...
    <div class="navbar">
        ...
        <a href="view_scholarships.php" class="active">View Scholarships</a>
    ...
    $sql = "SELECT scholarship_id, scholarship_name, scholarship_desc, grant_amount FROM scholarship WHERE company_id = '$company_email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<strong>Scholarship desc:</strong> " . $row["scholarship_desc"] . "<br>";
