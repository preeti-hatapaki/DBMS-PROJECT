...
$sql = "INSERT INTO scholarship (scholarship_name, state, caste, gender, tenth_score, twelfth_score, nationality, annual_income, grant_amount, company_id, scholarship_desc) VALUES ('$scholarship_name', '$state', '$caste', '$gender', '$tenth_score', '$twelfth_score', '$nationality', '$annual_income', '$grant_amount', '$company_email', '$scholarship_desc')";
